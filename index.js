...
fetch("http://209.97.186.249:1337/main").then(response => response.json()).then(data => {
...
fetch("http://209.97.186.249:1337/work-experiences").then(response => response.json()).then(data => {
